...
class MissionManagerNode(Node):
    ...
    def _target_locked(self, selected: dict | None, centered: bool) -> bool:
        ...
        perception_locked = target_state in ("LOCKED", "DROP_READY") or bool(selected.get("drop_perception_gate", False))
        if perception_locked and centered and confidence >= self.lock_min_confidence:
